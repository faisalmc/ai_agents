...
_Generated: 2025-08-06 04:07:00.355703_
...
router bgp 1001
 ...
 neighbor 2620:FC7:10:101::1 remote-as 100
 !
 address-family ipv4
  network 10.1.1.1 mask 255.255.255.255
  neighbor 10.10.1.1 activate
  no neighbor 2620:FC7:10:101::1 activate
 exit-address-family
 !
 address-family ipv6
  network 2620:FC7:1011::1/128
  neighbor 2620:FC7:10:101::1 activate
 exit-address-family
S-CE-1#
```
...
B        10.1.1.3/32 [20/0] via 10.10.1.1, 00:01:44
B        10.2.1.4/32 [20/0] via 10.10.1.1, 00:01:44
C        10.10.1.0/24 is directly connected, GigabitEthernet2
L        10.10.1.2/32 is directly connected, GigabitEthernet2
B        10.10.3.0/24 [20/0] via 10.10.1.1, 00:01:44
B        10.20.1.0/24 [20/0] via 10.10.1.1, 00:00:56
