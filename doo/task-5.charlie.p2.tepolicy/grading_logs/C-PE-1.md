# Grading Output for Task task-5.charlie.p2.tepolicy/
**Device:** C-PE-1 (192.168.100.131)
_Generated: 2025-08-05 03:00:59.318829_
...
Color: 66, End-point: 3.0.101.4
  ...
  Status:
    Admin: up  Operational: up for 00:01:12 (since Aug  5 06:59:44.283)
  Candidate-paths:
...
Tue Aug  5 07:00:56.699 UTC
Local  Outgoing    Prefix             Outgoing     Next Hop        Bytes       
Label  Label       or ID              Interface                    Switched    
------ ----------- ------------------ ------------ --------------- ------------
16001  Aggregate   SR Pfx (idx 1)     default                      0           
16002  Pop         SR Pfx (idx 2)     Gi0/0/0/1    3.3.9.2         1029        
16003  16003       SR Pfx (idx 3)     Gi0/0/0/0    3.3.8.2         0           
       16003       SR Pfx (idx 3)     Gi0/0/0/1    3.3.9.2         898         
16004  16004       SR Pfx (idx 4)     Gi0/0/0/0    3.3.8.2         224         
       16004       SR Pfx (idx 4)     Gi0/0/0/1    3.3.9.2         1218        
...
16007  16007       SR Pfx (idx 7)     Gi0/0/0/0    3.3.8.2         946         
16008  16008       SR Pfx (idx 8)     Gi0/0/0/0    3.3.8.2         0           
       16008       SR Pfx (idx 8)     Gi0/0/0/1    3.3.9.2         906         
...
24007  Pop         SR Adj (idx 3)     Gi0/0/0/0    fe80::5054:ff:fea5:ba01   \
                                                                   0           
24008  16006       SR TE: 1 [TE-INT]  Gi0/0/0/0    3.3.8.2         4224        
...
Tue Aug  5 07:00:57.426 UTC
BGP routing table entry for 3.0.101.77/32
Versions:
  Process           bRIB/RIB  SendTblVer
  Speaker                   3            3
Last Modified: Aug  5 07:00:42.992 for 00:00:14
...
Tue Aug  5 07:00:57.550 UTC
Type escape sequence to abort.
Sending 40, 100-byte ICMP Echos to 3.0.101.77 timeout is 2 seconds:
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
Success rate is 100 percent (40/40), round-trip min/avg/max = 7/8/13 ms
RP/0/RP0/CPU0:C-PE-1#
```
...
Tue Aug  5 07:01:01.861 UTC

Type escape sequence to abort.
Tracing the route to 3.0.101.77

 1  3.3.8.2 [MPLS: Labels 16006/16004 Exp 0] 14 msec  9 msec  8 msec 
 2  3.3.3.2 [MPLS: Label 16004 Exp 0] 10 msec  9 msec  15 msec 
 3  3.3.6.2 27 msec  *  11 msec 
RP/0/RP0/CPU0:C-PE-1#
```
