...
parser.add_argument(
    "--task",
    required=True,
    help="Task folder name (e.g., task-1, task-2B, misc) under configs/")
parser.add_argument(
    "--devices",
    nargs="+",
...
SHOW_LOGS_DIR    = os.path.join(TASK_FOLDER, "show_logs")
GRADING_LOGS_DIR = os.path.join(TASK_FOLDER, "grading_logs")
...
for dev in devices:
    ...
    try:
        ...
        for path in (full_log, grade_log):
