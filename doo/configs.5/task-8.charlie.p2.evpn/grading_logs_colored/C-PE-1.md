...
------------------------   -----------------------------   -----------------------------
<span style="background-color:red">evpn-vpws  RED20      UP   Gi0/0/0/2.20           UP       EVPN 30020,30020,::ffff:10.0.0.1 
                                                                                  UP </span>   
----------------------------------------------------------------------------------------
...
Group evpn-vpws, XC RED20, state is up; Interworking none
  ...
  EVPN: neighbor ::ffff:10.0.0.1, PW ID: evi 30020, ac-id 30020, <span style="background-color:red">state is up</span> ( established )
    XC ID 0xa0000003
    <span style="background-color:red">Encapsulation SRv6</span>
    Encap type Ethernet
...
*> [1][0000.0000.0000.0000.0000][30020]/120
                      0.0.0.0                                0 i
<span style="background-color:red">*>i[1][0000.1122.3344.5566.7788][30020]/120
                      2620:fc7:3:101::3</span>
                                                    100      0 i
